...
test("يثبت Fix 6 ربط دليل الدرس بنطاق الصفحات الموثق", () => {
  assert.match(pkg.version, /^0\.0\.(?:42|43|44|45|46)$/);
...
test("ترسل الواجهة شجرة الدروس إلى باني طلب التوليد دون مسح المفردات المكتملة", () => {
  ...
  assert.match(generator, /SOURCE_GENERATION_VERSION\s*=\s*"source-grounded-policy-ai-(?:12-advanced-visuals|13-trusted-enrichment|14-contextual-stimulus-alignment)"/);
});
