...
test("يثبت Phase 2-C4 Fix 2 وعقد ai-21 للنموذج العلمي المملوك للخادم", () => {
  ...
  assert.match(ASSESSMENT_GENERATION_V2_VERSION, /source-grounded-policy-ai-(?:20-unified-scientific-item|21-server-owned-scientific-item|22-server-owned-question-pattern|23-server-owned-assessment-contract|24-context-aware-moment-contract)/);
