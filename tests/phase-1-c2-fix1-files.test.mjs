...
test("يثبت إصدار النطاق الصارم وإعادة مطابقة المسودات القديمة", () => { assert.match(pkg.version, /^0\.0\.(?:38|39)$/); assert.match(retrieval, /strict-lesson-scope-2-tree-pages/); assert.match(storage, /sourceRetrievalVersion !== SOURCE_RETRIEVAL_VERSION/); });
