...
test("تتقاعد صفحات الفهرس اليدوية من واجهة H3 مع بقاء المحرك التاريخي", () => {
  assert.doesNotMatch(app, /صفحات الفهرس يدويًا|extract-source-structure-manual|parsePageSelection/);
  assert.match(structure, /parsePageSelection/);
});
