...
test("يثبت Fix 3 نمط السؤال بوصفه عقدًا خادميًا", () => {
  ...
  assert.match(ASSESSMENT_GENERATION_V2_VERSION, /source-grounded-policy-ai-(?:22-server-owned-question-pattern|23-server-owned-assessment-contract|24-context-aware-moment-contract)/);
