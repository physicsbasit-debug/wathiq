...
export const INTERNATIONAL_SCIENCE_QUESTION_STYLE_PRINCIPLES = [
  "يبقى مرجع التقويم العُماني هو الحاكم للدرجات والأنواع والأهداف ومستويات الصعوبة.",
  "تُستفاد من الممارسات الدولية في بناء سياق مشترك ومفردات مترابطة، لا في نسخ الأسئلة أو استبدال المنهج.",
  "تتنوع المفردات بين الفهم المفاهيمي، والتطبيق السياقي، والحساب، وقراءة البيانات، والاستقصاء، والمقارنة.",
  "يستخدم كل سؤال فعل أمر دقيقًا يوضح المطلوب، وتتناسب نقاط نموذج التصحيح مع الدرجة المخصصة للمفردة.",
  "تُبنى المشتتات في الاختيار من متعدد على أخطاء علمية أو حسابية محتملة، مع أربعة بدائل متجانسة وإجابة واحدة صحيحة.",
  "تُعرض مراجع الصفحات وأدلة المصدر للمعلم في نموذج الإجابة، ولا تُطبع داخل ورقة الطالب.",
] as const;
