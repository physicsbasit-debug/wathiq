...
function generationItemUserMessage(task: AssessmentGenerationItemSnapshot): string {
  ...
  if (task.status === "failed") {
    return `[${task.errorCode}] قاعدة البيانات ما زالت تستخدم عقد استرداد أقدم من عامل التوليد الحالي. أوقف إعادة المحاولة، نفّذ SQL الإصدار الحالي مرة واحدة، ثم استكمل الدورة نفسها.`;
  }
