...
export const MOCK_SOURCES = [
    {
        ...
        fingerprint: "file|كتاب الطالب|10|physics|الفصل الأول|2026|physics-grade-10-demo.pdf",
    ...
    },
    {
        ...
        fingerprint: "file|دليل المعلم|10|physics|الفصل الأول|2026|teacher-guide-grade-10-demo.pdf",
        authority: "منهج عُماني",
        ...
        status: "جاهز للفهرسة",
        uploadState: "غير مرفوع",
        drivePath: "واثق/01_مصادر_المنصة/01_المنهج_العماني/الصف_10/الفيزياء/الفصل_الأول/دليل_المعلم/",
    ...
    },
    {
        ...
        fingerprint: "url|مصدر عالمي|8|science|العام الكامل|صفحة حية|https://example.org/science-assessment",
        ...
        subjectId: "science",
        version: "صفحة حية",
        semester: "العام الكامل",
        url: "https://example.org/science-assessment",
        rightsConfirmed: true,
        status: "يحتاج مراجعة",
        drivePath: "واثق/01_مصادر_المنصة/03_مصادر_عالمية/العلوم/الصف_08/العام_الكامل/مصادر_مساندة/",
